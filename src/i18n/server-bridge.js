export const SERVER_LOCALE_KEY = 'haven_locale';
...
export function serverLocaleForDesktop(preference) {
  return DESKTOP_TO_SERVER_LOCALE[preference] || 'auto';
}

export function desktopLocaleForServer(preference) {
  return SERVER_TO_DESKTOP_LOCALE[preference] || null;
}

export function reconcileLanguagePreferences(desktopState, serverPreference, { isActive = true } = {}) {
